...
<body>
	...
	<a href="" title="Secure">Secure</a><br /-->
	
	<!--spring:url value="admin/" var="adminUrl" />
	<a href="{urlcont}{adminUrl}" title="Authorization">Admin</a-->
	...
	<spring:url value="login/" var="adminUrl" />
	<a href="${urlcont}${adminUrl}" title="Authorization">Authorization</a>

	<spring:url value="addUser/" var="addUserUrl" />
	<a href="${addUserUrl}" title="Registration">Registration</a><br />
